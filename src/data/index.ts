import { ColumnData, Lead, Activity, User, Task, Tag, EmailDraft, ChatConversation, ChatMessage, Group, Notification, Playbook, Board } from '@/shared/types';
...
export const initialLeads: Lead[] = [
    ...
    },
    {
        ...
        tags: [initialTags[1]],
        lastActivity: 'ontem',
        lastActivityTimestamp: new Date(Date.now() - 1000 * 60 * 60 * 24 * 1).toISOString(),
        status: 'Ativo',
    ...
    },
    {
        ...
        lastActivityTimestamp: new Date(Date.now() - 1000 * 60 * 60 * 24 * 2).toISOString(),
        status: 'Ativo',
    ...
    },
    {
        ...
        lastActivityTimestamp: new Date(Date.now() - 1000 * 60 * 60 * 24 * 3).toISOString(),
        status: 'Inativo',
    ...
    },
    {
        ...
        lastActivityTimestamp: new Date(Date.now() - 1000 * 60 * 60 * 24 * 4).toISOString(),
        status: 'Ativo',
