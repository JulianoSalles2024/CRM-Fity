...
// Replaced the previous malformed key with a valid one.
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <button
                        ...
                        className="flex-1 flex justify-center items-center gap-2 bg-violet-600 text-white px-4 py-2 rounded-md text-sm font-semibold hover:bg-violet-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
