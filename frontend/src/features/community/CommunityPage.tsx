...
import { Users, Search, Plus, TrendingUp, Clock, Users2 } from 'lucide-react';
...
interface CommunityPageProps {
  gruposContent?: React.ReactNode;
}

const CommunityPage: React.FC<CommunityPageProps> = ({ gruposContent }) => {
  const { user } = useAuth();
